                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{ route('country.create') }}">Add New</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('country.get-destroy',$country->id) }}"
...
<script type="text/javascript">
 ...
 $('.update_status').change(function() {
    ...
    if($(this).is(":checked")) { var status = 1;}
        ...
        //alert(id);
        $.ajax({
        url:"/admin/country/update-status/" +id + "/" +status ,
        success: function(e) {
        }
        });
});
