                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a class="btn btn-success pull-right" href="{{ route('city.create') }}"><span>Create City </span></a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('city.get-destroy',$city->id) }}"
...
<script type="text/javascript">
 ...
 $('.update_status').change(function() {
    ...
    if($(this).is(":checked")) { var status = 1;}
        ...
        //alert(id);
        $.ajax({
        url:"/admin/city/update-status/" +id + "/" +status ,
        success: function(e) {
        }
        });
});
