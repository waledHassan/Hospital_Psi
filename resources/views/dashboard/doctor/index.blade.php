            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{ route('doctor.create') }}">Add New</a>
            ...
            <table class=" table table-striped table-bordered" id="dataTables">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input type="checkbox" data-status="{{ $doctor->status }}" data-id="{{ $doctor->id }}"
                                    class="switch-input update_status" {{ ($doctor->status == 1) ? "checked" : "" }} >
                        ...
                        <td>
                            ...
                            <a href="{{ route('doctor.get-destroy',$doctor->id) }}"
...
<script type="text/javascript">
 ...
 $('.update_status').change(function() {
    ...
    if($(this).is(":checked")) { var status = 1;}
        ...
        //alert(id);
        $.ajax({
        url:"/admin/doctor/update-status/" +id + "/" +status ,
        success: function(e) {
        }
        });
});
