            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{ route('question.create') }}">Add New</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('question.get-destroy',$question->id) }}"
...
<script type="text/javascript">
 ...
 $('.update_status').change(function() {
    ...
    if($(this).is(":checked")) { var status = 1;}
        ...
        //alert(id);
        $.ajax({
        url:"/admin/question/update-status/" +id + "/" +status ,
        success: function(e) {
        }
        });
});
...
$("body").on("input",".ordering",function() {
   ...
   if(num){
       $.ajax({
           url: "/admin/question/orderings/" +id + "/" +num ,
           success: function(e) {
               //alert(e);
           }
       });
