                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{ route('level.create') }}">Add New</a>
                        ...
                        @foreach ($levels as $level)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('level.get-destroy', $level->id) }}"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('.update_status').change(function() {
            ...
            //alert(id);
            $.ajax({
                url: "/admin/level/update-status/" + id + "/" + status,
                success: function(e) {}
            });
        });
        ...
        $("body").on("input", ".ordering", function() {
            ...
            console.log(1233);
                ...
                $.ajax({
                    url: "/admin/level/orderings/" + id + "/" + num,
                    success: function(e) {
                        //alert(e);
                    }
                });
