                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{route('saas.member.create')}}">Add New</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($members as $member)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('saas.member.edit', $member->id) }}"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('.update_status').change(function() {
            ...
            //alert(id);
            $.ajax({
                url: "/saas/member/update-status/" + id + "/" + status,
                success: function(e) {}
            });
        });
    </script>
