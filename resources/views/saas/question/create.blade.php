...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{ route('saas.question.index') }}">Back</a>
                        </div>
                    </div>
                </div>
            </div>
           ...
           <form method="post" action="{{ route('saas.question.store') }}" enctype="multipart/form-data" id="user">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                   ...
                                   <div class="offset-md-4">
                                       ...
                                       <a href="{{ route('saas.question.index') }}" class="btn btn-danger"><span>Cancel</span></a>
