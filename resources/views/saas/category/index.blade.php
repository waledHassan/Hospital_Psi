                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a class="btn btn-brand btn-elevate btn-icon-sm" href="{{ route('saas.category.create') }}">Add New</a>
                ...
                <table class=" table table-striped table-bordered" id="dataTables">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('saas.category.edit',$category->id) }}"
                                    class="btn btn-success m-btn m-btn--icon btn-sm m-btn--icon-only"><i
                                        class="fa fa-edit"></i></a>

                                <a href="{{ route('saas.category.get-destroy',$category->id) }}"
...
<script type="text/javascript">
 ...
 $('.update_status').change(function() {
    ...
    if($(this).is(":checked")) { var status = 1;}
        ...
        //alert(id);
        $.ajax({
        url:"/saas/category/update-status/" +id + "/" +status ,
        success: function(e) {
        }
        });
});
