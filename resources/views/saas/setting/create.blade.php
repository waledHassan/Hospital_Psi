    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin::Form-->
                <form class="m-form" action="{{route('saas.setting.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="m-portlet__body">
                        <div class="m-form__section m-form__section--first">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control m-input" placeholder="Enter Meta Title" name="meta_title"> </textarea>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control m-input" placeholder="Enter Meta Title" name="meta_keyword"> </textarea>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control m-input" placeholder="Enter Meta Description" name="meta_description"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control m-input" placeholder="Enter Header script" name="header_script"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <textarea class="form-control m-input" placeholder="Enter Footer script" name="footer_script"></textarea>
                                </div>
                            </div>
