                    ...
                    <div class="kt-portlet">
                        ...
                        <div class="kt-portlet__body">
                            <ul class="nav nav-tabs nav-fill" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#m_tabs_2_7">company</a>
                                </li>
...
{{-- 
                                ...
                                <div class="tab-pane active" id="m_tabs_2_2" role="tabpanel">
                                ...
                                <div class="tab-pane active" id="m_tabs_2_8" role="tabpanel">

                                    @foreach ($admingroup->permissions()->where('name','like','%question%')->get() as $adminrole)
                                        <div class="form-group m-form__group row">
                                ...
                                <div class="tab-pane" id="m_tabs_category" role="tabpanel">
                                    ...
                                    @foreach ($admingroup->permissions()->where('name','like','%category%')->get() as $adminrole)
                                        <div class="form-group m-form__group row">
                                ...
                                <div class="tab-pane" id="m_tabs_2_3" role="tabpanel">
                                    ...
                                    @foreach ($admingroup->permissions()->where('name','like','%level%')->get() as $adminrole)
                                        <div class="form-group m-form__group row">
