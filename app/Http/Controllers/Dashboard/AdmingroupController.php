...
class AdmingroupController extends Controller
{
    ...
    {
        $Admingroups = Admingroup::where('company_id', auth()->user()->company_id)->get();

        return view('dashboard.groups.index', compact('Admingroups'));
    }
    ...
    {
        return view('dashboard.groups.show', compact('admingroup'));
    }
